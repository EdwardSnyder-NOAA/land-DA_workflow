...
prepend_path("MODULEPATH", "/scratch3/NCEPDEV/nems/Edward.Snyder/ss-192-cont/noaa-dev-demo/modulefiles/spack-stack-1.9.2/Core")
prepend_path("MODULEPATH", "/scratch3/NCEPDEV/nems/Edward.Snyder/ss-192-cont/noaa-dev-demo/modulefiles/spack-stack-1.9.2/intel-oneapi-mpi/2021.13-3tqt7kz/gcc/11.4.0")
...
setenv("APPTAINERENV_FC",  "/opt/intel/oneapi/mpi/2021.13/bin/mpiifort")
